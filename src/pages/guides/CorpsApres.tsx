  ...
  return (
    <ProductPage
      ...
      description={[
        ...
        "Parce que ton corps mérite d'être traité avec respect et douceur après ce qu'il a accompli. Pas de injonction à la reprise du sport. Juste de l'écoute et de la patience.",
      ]}
      chapters={[
